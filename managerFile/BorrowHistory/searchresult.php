<?php
	...
	$starttime=$_POST['starttime']?$_POST['starttime']:"1999-08-07T00:00:00";
	$endtime=$_POST['endtime']?$_POST['endtime']:"2099-08-07T00:00:00";
	$starttime_true=strtr($starttime,'T',' ');
	$endtime_true=strtr($endtime,'T',' ');
	echo $starttime_true;
	echo $endtime_true;
	...
	$sql = "select * from borrowhistory_view where borrowtime between '$starttime_true' and '$endtime_true' ";
	...
	$_SESSION['out_BookAll_history']=$out_ManagerAll;


	echo '<script>window.location="searchresult.html";</script>';
?>